...
const PrimaryButton = ({ text, arrow = false }) => {
  return (
    <button className="px-4 py-1.5 bg-button-bg dark:hover:bg-[hsl(0,0%,10%)] hover:hover:bg-[hsl(0,0%,90%)] cursor-pointer rounded-[8px] transition-all duration-300 ease-out flex justify-center items-center gap-1.5 group active:scale-[0.97]">
